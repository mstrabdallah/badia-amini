import style from './styles/cars-insurance.module.scss'
...
export default function CarsInsurance() {
    ...
    const StepsToBuyData = {
        title: 'خطوات شراء تأمين السيارة',
        des: 'لشراء تأمين لسيارتك كل ما عليك فعله هو اتباع الخطوات التالية.',
        sub: 'شراء تأمين لسيارتك الآن'
    }
    return (
        <>
            <section className={style.CarsInsurance}>

                <div className='page_'>
                    <Head_Section />
                    <InsuranceChoose_Section />
                    <StepsToBuy_Sections data={StepsToBuyData} />
                    <WhyBuyFromOmni title={'ليه أشتري تأمين سيارة من أمني ؟'} />
                    <InsuranceCoverage />
                    <CommonQuestions />
                    <CustomerReviews title={'آراء العملاء  <br />في أنظمة تأمين السيارات لدينا'} des={'نستعرض لك بعض آراء العملاء والمستخدمين <br />في أنظمة تأمين السيارات المتاحة لدينا.'} />
                    <StillHaveQuestions />
                </div>
            </section>
        </>
