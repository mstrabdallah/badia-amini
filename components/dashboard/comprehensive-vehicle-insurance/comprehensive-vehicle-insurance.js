...
import StepFullInsurance from '../tools/steps/steps/step-fullInsurance'
...
const ComprehensiveVehicleInsurance = () => {
    ...
    useEffect(() => {
        dispatch(setType('comprehensive'))
    })
    return (
        <div className="container_">
            <div className={style.StepsStyles}>

                <HeaderPagesS1 title={'شراء وثيقة تأمين شامل جديده'} />
...
export default ComprehensiveVehicleInsurance;
